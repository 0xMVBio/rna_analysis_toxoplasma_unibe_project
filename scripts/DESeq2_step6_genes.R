...
plotCounts(dds, gene = "ENSMUSG00000028270", intgroup = c("infection", "genotype"))

# Stat1 - signal transducer and activator of transcription 1
# central transcription factor for both type I and II interferon signaling
plotCounts(dds, gene = "ENSMUSG00000026104", intgroup = c("infection", "genotype"))

# Irgm1 - immunity related GTPase family M member 1
# important for autophagy and killing of intracellular pathogens
plotCounts(dds, gene = "ENSMUSG00000020009", intgroup = c("infection", "genotype"))
